...
public class GlitchingeffectProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, Entity entity) {
		...
		if (entity instanceof LivingEntity _livEnt ? _livEnt.hasEffect(AetheriumResourcesReloadedModMobEffects.CORRUPTED_EFFECT.get()) : false) {
			if (_evt.getRenderer() instanceof PlayerRenderer) {
				...
				new com.kleiders.kleidersplayerrenderer.ClassicPlayerRenderer(new EntityRendererProvider.Context(dis, mc.getItemRenderer(), mc.getBlockRenderer(), dis.getItemInHandRenderer(), mc.getResourceManager(), mc.getEntityModels(), mc.font),
						new ResourceLocation("aetherium_resources_reloaded:textures/entities/glitching_overlay.png"))
