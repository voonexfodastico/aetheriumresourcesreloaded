...
public class HandskinprocedureProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, Entity entity) {
		...
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == AetheriumResourcesReloadedModItems.DEMONICAL_HAND.get()
				|| (entity instanceof LivingEntity _livEnt ? _livEnt.getOffhandItem() : ItemStack.EMPTY).getItem() == AetheriumResourcesReloadedModItems.DEMONICAL_HAND.get()) {
