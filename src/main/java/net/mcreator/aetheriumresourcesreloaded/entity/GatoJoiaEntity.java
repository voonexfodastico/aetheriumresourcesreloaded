...
package net.mcreator.aetheriumresourcesreloaded.entity;
...
public class GatoJoiaEntity extends Monster {
	...
	public GatoJoiaEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AetheriumResourcesReloadedModEntities.GATO_JOIA.get(), world);
	}

	public GatoJoiaEntity(EntityType<GatoJoiaEntity> type, Level world) {
		super(type, world);
		maxUpStep = 1f;
		xpReward = 0;
		setNoAi(false);
		setCustomName(Component.literal("GATO JOIA"));
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(9, new RemoveBlockGoal(Blocks.AMETHYST_BLOCK, this, 1, (int) 5));
	}
