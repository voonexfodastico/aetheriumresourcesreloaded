...
@Mod("aetherium_resources_reloaded")
public class AetheriumResourcesReloadedMod {
	public static final Logger LOGGER = LogManager.getLogger(AetheriumResourcesReloadedMod.class);
	public static final String MODID = "aetherium_resources_reloaded";
