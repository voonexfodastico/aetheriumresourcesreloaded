...
public class Modelhauntedmask2<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "hauntedmask2"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition mascara = partdefinition.addOrReplaceChild("mascara",
				CubeListBuilder.create().texOffs(8, 0)
						.addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 0.5F, new CubeDeformation(0.0F)).texOffs(0, 18)
						.addBox(3.7F, -4.4F, -3.8F, 0.3F, 0.6F, 5.0F, new CubeDeformation(0.0F)).texOffs(0, 18)
						.addBox(-4.3F, -4.4F, -3.8F, 0.3F, 0.6F, 5.0F, new CubeDeformation(0.0F)),
